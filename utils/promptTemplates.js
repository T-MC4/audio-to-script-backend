...
export const statefulChatPrompt = (transcript) => {
    return ChatPromptTemplate.fromPromptMessages([
        ...
        *WFPTR*
        ...
        12. Make sure to not make the script too specific to the prospect the sales rep was talking to. it should not include any personal information about the prospect.
...
// PROMPT TEMPLATE WITH MEMORY SO I CAN JUST RESPOND "continue:"
export const highEqStatefulChatPrompt = (transcript) => {
    return ChatPromptTemplate.fromPromptMessages([
        SystemMessagePromptTemplate.fromTemplate(
            `The job that needs to be done
...
// PROMPT TEMPLATE WITH MEMORY SO I CAN JUST RESPOND "continue:"
export const statefulSettingChatPrompt = (transcript) => {
    return ChatPromptTemplate.fromPromptMessages([
        SystemMessagePromptTemplate.fromTemplate(
            `​The job that needs to be done
...
export const testPrompt = ChatPromptTemplate.fromPromptMessages([
    SystemMessagePromptTemplate.fromTemplate(
        `The job that needs to be done
